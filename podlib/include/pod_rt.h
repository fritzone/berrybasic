 ...
 * function here routes through the PodServices table the loader hands the POD at
 * entry; crt0.c stashes that table in `pod_svc` before main() runs.
 */
#ifndef POD_RT_H
#define POD_RT_H
#include <pod.h>

extern const PodServices *pod_svc;   /* set by crt0 before main() */
